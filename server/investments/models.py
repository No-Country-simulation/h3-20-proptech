...
class Investment(models.Model):
    ...
    payments_amount = models.DecimalField(max_digits=10, decimal_places=2, default=0.0, blank=True)
    ...
    deposited_cuota = models.DecimalField(max_digits=10, decimal_places=2, default=0.0, blank=True)
