...
from .views import RegisterView, RegisterWithKYC, ValidateUserView, UpdatePersonalDataView, AddGarantorView, CustomTokenObtainPairView, UpdateUserInformationView, UserListView, UserDetailView, UpdateUserStatusView
...
urlpatterns = [
    ...
    path('update-status/<int:user_id>/', UpdateUserStatusView.as_view(), name='update_status'),
]
