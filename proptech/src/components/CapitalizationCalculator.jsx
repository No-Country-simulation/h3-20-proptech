...
//             return npery * (Math.pow(1 + tea / 100, 1 / npery) - 1);
//         };
//         const nominalRate = calculateNominalRate(annualRateValue, 12);
//         const monthlyInterestRate = nominalRate / 12;
//         const monthlyRate = isYears ? monthlyInterestRate : annualRateValue / 100;
...
//                 netoAPagar: netoAPagar.toFixed(2),
//                 capitalizacion: capitalizacion.toFixed(2),
//                 dueDate: currentDate.toISOString().split("T")[0], // Save as YYYY-MM-DD
//             });
...
//                 </div>
//                 <div>
//                     <label className="font-bold text-text-primary mb-1">Tasa de Interés Anual (TEA)</label>
//                     <input
//                         type="number"
//                         placeholder="Ingrese la tasa anual (TEA)"
//                         value={annualRate}
...
//                 </div>
//                 <div>
//                     <label className="font-bold text-text-primary mb-1">Plazo en Años</label>
//                     <input
//                         type="number"
...
//                 </div>
//                 <div>
//                     <label className="font-bold text-text-primary mb-1">Deposited Cuota</label>
//                     <input
//                         type="number"
//                         placeholder="Ingrese el monto depositado"
//                         value={depositedCuota}
//                         onChange={(e) => setDepositedCuota(e.target.value)}
//                         className="input-field"
//                     />
//                 </div>
//                 <div className="flex space-x-4">
...
//                                     <td className="border px-2 py-1">{detail.netoAPagar}%</td>
//                                     <td className="border px-2 py-1">{detail.capitalizacion}</td>
//                                     <td className="border px-2 py-1">{detail.dueDate}</td>
//                                 </tr>
//                             ))}
//                         </tbody>
//                     </table>
